...
node_n = %w[ n0 k6 j5 j3 j5k6 j25k6 k26j5 k126j5 j6 k5 k1j6 k16 k56 j56 
k127 k127j5 j34k5 j2 j2k6 k2 k25 j23 j23k6 k12j5 k2j5 k2j56 j2k56 
j34k6 j34k16 x1k2j5 x1k26j5 j3k6 k1j5 k2j6 j2k5 k26 j25 ]

key_list = %w[ n0 j7 k4 j37 k14 j367 k145 n145 n367 n14 n37 n4 n7 j0 k0 ]
...
select_sig = gets.chomp 
 if select_sig =~ /ndex|ist/
  ...
  puts   
  puts node_u     
 elsif (select_sig == 'n0' or select_sig == 'Am' or select_sig == 'C')    
  puts   
  puts Key.new.n0 
  ...
  puts  
  puts Key.new.n7 
 elsif (select_sig == 'j0' or select_sig == 'Abm' or select_sig == 'Cb')    
  puts   
  puts Key.new.j0
 elsif (select_sig == 'k0' or select_sig == 'A#m' or select_sig == 'C#')
  puts  
  puts Key.new.k0 
