...
function metaMorph(x) {
  document.getElementById("str_F").textContent = x.str0.slice( 0,61)
  document.getElementById("str_C").textContent = x.str1.slice( 0,61)
  document.getElementById("str_G").textContent = x.str2.slice( 0,61)
  document.getElementById("str_D").textContent = x.str3.slice( 0,61)
  document.getElementById("str_A").textContent = x.str4.slice( 0,61)
  document.getElementById("str_E").textContent = x.str5.slice( 0,61)
  document.getElementById("str_B").textContent = x.str6.slice( 0,61)
}
