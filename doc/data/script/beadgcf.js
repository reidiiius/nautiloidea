...
function purfectFifths(qp) {
  fingerBoard(
    (qp.slice(55,60).concat(qp.slice(0,55))),
    (qp.slice(20,60).concat(qp.slice(0,20))),
    (qp.slice(45,60).concat(qp.slice(0,45))),
    (qp.slice(10,60).concat(qp.slice(0,10))),
    (qp.slice(35,60).concat(qp.slice(0,35))),
    (qp.slice( 0,60).concat(qp.slice(0, 0))),
    (qp.slice(25,60).concat(qp.slice(0,25)))
  );
}

function purfectFourths(qp) {
  fingerBoard(
    (qp.slice(25,60).concat(qp.slice(0,25))),
    (qp.slice( 0,60).concat(qp.slice(0, 0))),
    (qp.slice(35,60).concat(qp.slice(0,35))),
